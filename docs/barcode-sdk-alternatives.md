...
This project uses Scandit Web SDK 8.4.0 (paid licence provided by hackathon organisers). The features we rely on:
...
**For the hackathon:** Keep Scandit — the organisers provided the licence key, it works, and BarcodeFind already ships the UI. Don't rebuild it under time pressure.
