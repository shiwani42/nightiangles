...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "TrailMate — AI shopping concierge" },
      { name: "description", content: "Plan your Swiss outdoor trip with TrailMate, your AI gear concierge." },
      { property: "og:title", content: "TrailMate" },
      { property: "og:description", content: "Plan your Swiss outdoor trip with TrailMate." },
    ],
  }),
  component: Index,
});
